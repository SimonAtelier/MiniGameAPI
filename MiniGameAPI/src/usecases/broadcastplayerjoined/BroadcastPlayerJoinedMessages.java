...
public interface BroadcastPlayerJoinedMessages {
	...
	static final String PLAYER_JOINED_NO_SUCH_GAME_MESSAGE = "The game '$name$' does not exist.";
	
	static final String PLAYER_JOINED_GAME_JOINED_PLAYER_ID_IS_INVALID = "Invalid player-id.";
